...
export default function ReceiptPreview({ data, onClose }: { data: any, onClose: () => void }) {
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-white rounded-[2.5rem] w-full max-w-md shadow-2xl overflow-hidden relative animate-in zoom-in-95 duration-300">
        ...
        <div className="p-8 relative">
            ...
            <div className="text-center mb-8">
                ...
                <h2 className="text-3xl font-black text-slate-800 tracking-tight">#{data.id.split('-')[1]}</h2>
            ...
            <div className="space-y-4 border-y border-slate-100 py-8 mb-8">
                <div className="flex justify-between items-end">
                    <div className="text-left">
                        ...
                        <p className="font-bold text-slate-800 text-lg">{data.studentId}</p>
                    </div>
                </div>
                <div className="flex justify-between items-end">
                    <div className="text-left">
            ...
            <div className="flex items-center gap-6 bg-slate-50 p-6 rounded-3xl border border-slate-100">
                <div className="bg-white p-2 rounded-xl shadow-sm border border-slate-100">
                    <QrCodeIcon className="h-14 w-14 text-slate-800" />
                </div>
            ...
            <div className="grid grid-cols-2 gap-3 mt-10">
                <button className="flex items-center justify-center gap-2 py-4 bg-slate-100 text-slate-800 rounded-2xl font-bold text-sm hover:bg-slate-200 transition-all">
                    <ShareIcon className="h-5 w-5" />
                    Partager
                </button>
                <button className="flex items-center justify-center gap-2 py-4 bg-blue-600 text-white rounded-2xl font-black text-sm shadow-lg hover:bg-blue-700 transition-all">
